...
export const Loginuser = async (req,res,next) =>{
    try {
        ...
        console.log(user)     //other than protected field in console.log
        console.log(user._doc)     //password here & protected in console.log
        if(!user){
       ...
       res.cookie("access_token", token, {
        ...
        }).status(201).send("user Authenticated!")
    } catch (error) {
        return next(Createerror(300, "Error is Occured!"))
    }
}
